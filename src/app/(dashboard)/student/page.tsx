...
export default function StudentDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-3 flex-wrap">
          <Link href="/student/roadmap">
            <Button variant="outline" className="border-emerald-500/50 text-emerald-600 hover:bg-emerald-500 hover:text-white" leftIcon={<Brain className="w-5 h-5" />}>
              Learning Path
            </Button>
          </Link>
          <Link href="/student/feed">
            <Button variant="outline" className="border-primary/50 text-primary hover:bg-primary hover:text-white" leftIcon={<Zap className="w-5 h-5" />}>
              Stamina Feed
            </Button>
          </Link>
      ...
      {/* Curriculum Depth Roadmap Promo Card */}
      <Card variant="bordered" className="bg-gradient-to-r from-emerald-500/10 via-background to-teal-500/10 border-emerald-500/25">
        <CardContent className="flex flex-col md:flex-row items-center justify-between p-6 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-foreground">Duolingo-Style Curriculum Roadmap</h2>
              <p className="text-sm text-muted">
                Track your structured progress across multiple fields (AI, Psychology, Marketing) and unlock learning nodes dynamically.
              </p>
            </div>
          </div>
          <div className="flex gap-2">
            <Link href="/student/roadmap">
              <Button size="lg" variant="outline" className="border-emerald-500/50 text-emerald-600 hover:bg-emerald-500 hover:text-white whitespace-nowrap">
                View Roadmap
              </Button>
            </Link>
            <Link href="/student/feed?feedType=niche">
              <Button size="lg" className="whitespace-nowrap bg-emerald-600 hover:bg-emerald-700 text-white" rightIcon={<ArrowRight className="w-5 h-5" />}>
                Study Feed
              </Button>
            </Link>
          </div>
      ...
      {/* Stamina Axis Promo Card */}
      <Card variant="bordered" className="bg-gradient-to-r from-primary/10 via-indigo-950/5 to-secondary/10 border-indigo-200">
        <CardContent className="flex flex-col md:flex-row items-center justify-between p-6 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-foreground">Try the Adaptive Stamina Feed</h2>
              <p className="text-sm text-muted">
                Transition from quick micro-learning card snippets to deep mini-articles dynamically as you read!
              </p>
            </div>
          </div>
          <Link href="/student/feed">
            <Button size="lg" className="whitespace-nowrap bg-indigo-600 hover:bg-indigo-700 text-white" rightIcon={<ArrowRight className="w-5 h-5" />}>
              Start Reading
            </Button>
          </Link>
        </CardContent>
