        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted">
              Discover how Tidbit&apos;s AI-powered features transform the way you learn and teach.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted max-w-2xl mx-auto">
              Tidbit is packed with features to enhance your learning experience.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted mb-8">
            Start your learning journey today with Tidbit&apos;s powerful AI-driven platform.
          </p>
