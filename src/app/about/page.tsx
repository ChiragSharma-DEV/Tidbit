...
const team = [
  {
    name: 'Aafreen Khan',
    role: 'Founder ',
    description: 'Former hackathon idealist with 3 years of experience in team Leadership.',
  },
  {
    name: 'Arohi kate ',
    role: 'Co-Founder',
  ...
  },
  {
    name: 'Parth Jakar',
    role: 'CTO',
    description: 'Experianced in technical stuff and development, ',
  },
  {
    name: 'Chirag Sharma',
    role: 'CEO',
    description: 'Enthusiast in AI and everything related to it.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted mb-4">
                Tidbit was founded with a simple yet powerful vision: to harness the
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted max-w-2xl mx-auto">
              Meet the passionate people behind Tidbit.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member) => (
