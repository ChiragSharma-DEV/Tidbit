...
// ==========================================
// Stamina Axis (Adaptive Feed) Types
// ==========================================

export type StaminaGate = 'short' | 'medium' | 'long';

export interface FeedCardShortVariant {
  headline: string;
  summary: string;
  takeaway: string;
}

export interface FeedCardMediumVariant {
  summary: string;
  explanation: string;
  bullets: string[];
  example: string;
...
export interface FeedCardLongVariant {
  title: string;
  introduction: string;
  content: string; // Case study / code breakdown
  takeaways: string[];
}

export interface FeedCardVariants {
  short: FeedCardShortVariant;
  medium: FeedCardMediumVariant;
  long: FeedCardLongVariant;
}
...
export interface IFeedCard {
  ...
  activeRecallQuiz?: ActiveRecallQuiz;
  createdAt: Date;
  updatedAt: Date;
}

// ==========================================
// Axis 2: Depth Progression & Curriculum Types
// ==========================================
...
export interface NicheCurriculum {
  nicheId: string;
  title: string;
  nodes: CurriculumNode[];
}

export interface INicheCurriculum extends NicheCurriculum {
  _id: ObjectId;
  createdAt: Date;
  updatedAt: Date;
}
...
export interface InterleavedFeedItem {
  _id: string;
  type: 'card' | 'milestone' | 'refresher';
  nicheId: string;
  nodeIndex: number;
  conceptKey?: string;
  order?: number;
