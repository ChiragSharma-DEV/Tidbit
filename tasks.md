# 🚀 Tidbit AI - PERSONALIZED LEARNING PLATFORM
...
- [ ] **T-1.1.1** Initialize Next.js 14 project with App Router
  ```bash
  npx create-next-app@latest Tidbit-ai --typescript --tailwind --eslint --app
  ```
...
*Built with 💪 by the Tidbit AI Team*
